        ...
        return (
            <div>
                <div className="scheduleHourContainer">
                    ...
                    <div className="scheduleHourItem">
                        <input type="text" value={temp} style={{width: 40}} readOnly={true}/>&deg;C
                    </div>
                    <div className="scheduleHourItem">
                ...
                <Slider step={0.5} defaultValue={temp} min={15} max={23} onChange={(e,v) => actions.updateTemp(day, index, v)} />
